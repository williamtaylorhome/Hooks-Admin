		...
		dataZoom: [
			{
				...
				xAxisIndex: [0],
				bottom: 0,
				startValue: 0, //The starting value of the data window range
				endValue: 9, //The end value of the data window range
				handleStyle: {
					color: "#6b9dfe"
				},
				textStyle: {
