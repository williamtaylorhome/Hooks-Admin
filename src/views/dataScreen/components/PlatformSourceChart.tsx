...
const PlatformSourceChart = () => {
	let data = [
		{
			value: 40,
			name: "Smart cultural tourism platform",
			percentage: "40%"
		},
		{
			value: 10,
						...
						itemStyle: {
							color: {
								...
								colorStops: [
									{
										offset: 0,
										color: "rgba(51,149,191,0.5)" // color at 0%.
									},
									{
										offset: 1,
										color: "rgba(51,149,191,0)" // Color at 100%.
									}
								],
						...
						itemStyle: {
							color: {
								...
								colorStops: [
									{
										offset: 0,
										color: "rgba(0,0,0,0)" // color at 0%.
									},
									{
										offset: 1,
										color: "rgba(51,149,191,0.5)" // Color at 100%.
									}
								],
								global: false // The default is false
							}
						...
						itemStyle: {
							...
							color: {
								...
								colorStops: [
									{
										offset: 0,
										color: "rgba(51,149,191,0)" // color at 0%.
									},
									{
										offset: 1,
										color: "rgba(51,149,191,0.5)" // Color at 100%.
						...
						itemStyle: {
							...
							color: {
								...
								colorStops: [
									...
									{
										offset: 1,
										color: "rgba(0,0,0,0)" // Color at 100%.
									}
								],
								global: false // The default is false
							}
